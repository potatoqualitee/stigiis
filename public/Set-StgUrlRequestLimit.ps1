function Set-StgUrlRequestLimit {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS C:\> Set-StgUrlRequestLimit -ComputerName web01

        Updates specific setting to be compliant on web01

    .EXAMPLE
        PS C:\> Set-StgUrlRequestLimit -ComputerName web01 -Credential ad\webadmin
    ...
    begin {
        ...
        $scriptblock = {
            ...
            foreach ($webname in $webnames) {
                ...
                $postconfigMaxUrl = Get-WebConfigurationProperty -Filter $filterpath -Name MaxUrl
                if ($postconfigMaxUrl.Value -le $MaxUrl) {
                    $compliant = $true
                } else {
                    $compliant = $false
                }
