function Get-StgAppPoolRapidFailProtection {
    ...
    .EXAMPLE
        PS C:\> Get-StgAppPoolRapidFailProtection -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Get-StgAppPoolRapidFailProtection -ComputerName web01 -Credential ad\webadmin
        ...
        $scriptblock = {
            ...
            foreach ($pool in $AppPools) {
                ...
                [pscustomobject] @{
                    ...
                    Value          = $preconfigRapidFailEnabled
