function Set-StgIndexConfiguration {
<#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS C:\> Set-StgIndexConfiguration -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Set-StgIndexConfiguration -ComputerName web01 -Credential ad\webadmin
