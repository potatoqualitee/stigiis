function Get-StgAnonymousAuth {
    ...
    .EXAMPLE
        PS C:\> Get-StgAnonymousAuth -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Get-StgAnonymousAuth -ComputerName web01 -Credential ad\webadmin
...
#>
    ...
    begin {
        ...
        $scriptblock = {
            ...
            if (-not $preconfigAnonymousAuthentication.Value) {
                $compliant = $true
            } else {
                $compliant = $false
            }
            ...
            [pscustomobject] @{
                ...
                Value        = $preconfigAnonymousAuthentication.Value
                Compliant    = $compliant
            }
        }
    }
