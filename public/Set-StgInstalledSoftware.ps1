function Set-StgInstalledSoftware {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS C:\> Set-StgInstalledSoftware -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Set-StgInstalledSoftware -ComputerName web01 -Credential ad\webadmin
