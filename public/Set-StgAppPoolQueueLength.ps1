function Set-StgAppPoolQueueLength {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS C:\> Set-StgAppPoolQueueLength -ComputerName web01

        Updates specific setting to be compliant on web01

    .EXAMPLE
        PS C:\> Set-StgAppPoolQueueLength -ComputerName web01 -Credential ad\webadmin
