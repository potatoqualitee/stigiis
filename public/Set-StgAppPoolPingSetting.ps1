function Set-StgAppPoolPingSetting {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        PS C:\> Set-StgAppPoolPingSetting -ComputerName web01

        Updates specific setting to be compliant on web01

    .EXAMPLE
        PS C:\> Set-StgAppPoolPingSetting -ComputerName web01 -Credential ad\webadmin
