...
.DESCRIPTION
    ...
    .EXAMPLE
        PS C:\> Get-StgDebugSetting -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Get-StgDebugSetting -ComputerName web01 -Credential ad\webadmin
    ...
    begin {
        ...
        $scriptblock = {
            ...
            foreach ($webname in $webnames) {
                $DebugBehavior = Get-WebConfigurationProperty -Location $webname -Filter $filterpath -Name Debug
