function Get-StgHighBit {
    ...
    .EXAMPLE
        PS C:\> Get-StgHighBit -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Get-StgHighBit -ComputerName web01 -Credential ad\webadmin
    ...
    begin {
        ...
        $scriptblock = {
            ...
            foreach ($webname in $webnames) {
                $HighBit = Get-WebConfigurationProperty -Location $webname -Filter $filterpath -Name allowHighBitCharacters
