function Get-StgAppPoolRecyclePrivateMemory {
    ...
    .EXAMPLE
        PS C:\> Get-StgAppPoolRecyclePrivateMemory -ComputerName web01

        Gets required information from web01

    .EXAMPLE
        PS C:\> Get-StgAppPoolRecyclePrivateMemory -ComputerName web01 -Credential ad\webadmin
